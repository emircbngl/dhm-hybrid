...
class ReconTab(QWidget):
    ...
    def __init__(self, parent: QWidget = None):
        ...
        rg.addWidget(QLabel("Method"), row, 0)
        rg.addWidget(self.method_combo, row, 1); row += 1
        ...
        rg.addWidget(QLabel("FFT Backend"), row, 0)
        rg.addWidget(self.fft_backend_combo, row, 1); row += 1
        ...
        rg.addWidget(self.wavelength_nm, row, 1); row += 1
        ...
        rg.addWidget(self.pixel_um, row, 1); row += 1
        ...
        rg.addWidget(QLabel("Magnification"), row, 0)
        rg.addWidget(self.magnification, row, 1); row += 1
        ...
        rg.addWidget(self.pixel_is_effective_cb, row, 0, 1, 2); row += 1
